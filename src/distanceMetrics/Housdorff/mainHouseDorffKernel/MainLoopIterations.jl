...
function mainLoopIterationsKernel(reducedArrays, metaData, metadataDims::Tuple{UInt8, UInt8, UInt8}, resArrays, resArraysCounters, datablockDim, mainQuesCounterArr, mainWorkQueueArr, tailCounter, tailParts::UInt8, numberOfThreadBlocks::UInt16, isOddPass,
	iterationNumber, fp, fn)
	...
	macro innersingleDataBlockPass(ispassGoldd::Bool, currMatadataBlockX::UInt8, currMatadataBlockY::UInt8, currMatadataBlockZ::UInt8)
		singleDataBlockPass(reducedArrays[ispassGoldd*2+1], reducedArrays[ispassGoldd*2+2], iterationNumberShmem[], ((currMatadataBlockX - 1) * 32) + 1, ((currMatadataBlockY - 1) * 32) + 1, ((currMatadataBlockZ - 1) * 32) + 1, isMaskFull, resShmem, locArr,
			metaData, metadataDims, isPassGold, currMatadataBlockX, currMatadataBlockY, currMatadataBlockZ, mainQuesCounterArr[!isOddPassShmem[]+1], mainWorkQueueArr[!isOddPassShmem[]+1], resArrays[ispassGoldd+1], resArraysCounters[ispassGoldd+1])
	...
	"""
	function loadOwnedWorkQueueIntoShmem(mainWorkQueue, mainQuesCounter, toIterWorkQueueShmem, positionInMainWorkQueaue, numberOfThreadBlocks, tailParts)
	...
	"""
	function singleDataBlockPass(analyzedArr, refAray, iterationNumber, blockBeginingX, blockBeginingY, blockBeginingZ, isMaskFull, resShmem, locArr, metaData, metadataDims::Tuple{UInt8, UInt8, UInt8}, isPassGold::Bool, currMatadataBlockX::UInt8,
		currMatadataBlockY::UInt8, currMatadataBlockZ::UInt8, mainQuesCounter, mainWorkQueue, resArray, resArraysCounter)
