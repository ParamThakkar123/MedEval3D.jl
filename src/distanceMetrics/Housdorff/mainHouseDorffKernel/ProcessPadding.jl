...
"""
function processAllPaddingPlanes(x::UInt16, y::UInt16, z::UInt16, shmem, currBlockX::UInt16, currBlockY::UInt16, currBlockZ::UInt16, sourceArray, referenceArray, resArr, metaData, metadataDims, isPassGold::Bool, locArr, resArraysCounter, iterationNumber)
...
we need to pass data to source array about new "trues"
	...
	isPassGold - true if we are dilatating currently gold standard mask false if we are dilatating other mask
"""
function processPaddingPlane(paddingVal::Bool, isOfIntrest::Bool, correctedX::UInt16, correctedY::UInt16, correctedZ::UInt16, nextBlockXIncrease::Bool, nextBlockYIncrease::Bool, nextBlockZIncrease::Bool, nextBlockXDecrease::Bool, nextBlockYDecrease::Bool,
	nextBlockZDecrease::Bool, sliceNumbManual::UInt8, shmem, currBlockX::UInt16, currBlockY::UInt16, currBlockZ::UInt16, sourceArray, referenceArray, resArr, metaData, metadataDims, isPassGold::Bool, mainQuesCounter, mainWorkQueue, resArraysCounter,
	iterationNumber)
...
function processsPaddingTOP(shmem, currBlockX, currBlockY, currBlockZ, sourceArray, referenceArray, resArr, metaData, metadataDims, isPassGold, x, y, z, mainQuesCounter, mainWorkQueue, resArraysCounter, iterationNumber)
	processPaddingPlane(
		sourceArray[threadIdxX(), threadIdxY(), 1], x, y, z - 1, false, false, false, false, false, true, 1, shmem, currBlockX, currBlockY, currBlockZ, sourceArray, referenceArray, resArr, metaData, metadataDims, isPassGold, mainQuesCounter, mainWorkQueue,
		resArraysCounter, iterationNumber)# this arguments will be the same for all invocations
end
...
function processsPaddingBOTTOM(shmem, currBlockX, currBlockY, currBlockZ, sourceArray, referenceArray, resArr, metaData, metadataDims, isPassGold, x, y, z, mainQuesCounter, mainWorkQueue, resArraysCounter, iterationNumber)
	processPaddingPlane(
		sourceArray[threadIdxX(), threadIdxY(), 34], x, y, z + 34, false, false, true, false, false, false, 3, shmem, currBlockX, currBlockY, currBlockZ, sourceArray, referenceArray, resArr, metaData, metadataDims, isPassGold, mainQuesCounter,
		mainWorkQueue, resArraysCounter, iterationNumber)# this arguments will be the same for all invocations
end
...
function processsPaddingFront(shmem, currBlockX, currBlockY, currBlockZ, sourceArray, referenceArray, resArr, metaData, metadataDims, isPassGold, x, y, z, mainQuesCounter, mainWorkQueue, resArraysCounter, iterationNumber)
	processPaddingPlane(
		sourceArray[threadIdxX(), 34, threadIdxY()], x, y + 34, z, false, true, false, false, false, false, 5, shmem, currBlockX, currBlockY, currBlockZ, sourceArray, referenceArray, resArr, metaData, metadataDims, isPassGold, mainQuesCounter,
		mainWorkQueue, resArraysCounter, iterationNumber)# this arguments will be the same for all invocations
end
...
function processsPaddingBack(shmem, currBlockX, currBlockY, currBlockZ, sourceArray, referenceArray, resArr, metaData, metadataDims, isPassGold, x, y, z, mainQuesCounter, mainWorkQueue, resArraysCounter, iterationNumber)
	processPaddingPlane(
		sourceArray[threadIdxX(), 1, threadIdxY()], x, y - 1, z, false, false, false, false, true, false, 7, shmem, currBlockX, currBlockY, currBlockZ, sourceArray, referenceArray, resArr, metaData, metadataDims, isPassGold, mainQuesCounter, mainWorkQueue,
		resArraysCounter, iterationNumber)# this arguments will be the same for all invocations
end
...
function processsPaddingLeft(shmem, currBlockX, currBlockY, currBlockZ, sourceArray, referenceArray, resArr, metaData, metadataDims, isPassGold, x, y, z, mainQuesCounter, mainWorkQueue, resArraysCounter, iterationNumber)
	processPaddingPlane(
		sourceArray[1, threadIdxX(), threadIdxY()], x - 1, y, z, false, false, false, true, false, false, 9, shmem, currBlockX, currBlockY, currBlockZ, sourceArray, referenceArray, resArr, metaData, metadataDims, isPassGold, mainQuesCounter, mainWorkQueue,
		resArraysCounter, iterationNumber)# this arguments will be the same for all invocations
end
...
function processsPaddingRight(shmem, currBlockX, currBlockY, currBlockZ, sourceArray, referenceArray, resArr, metaData, metadataDims, isPassGold, x, y, z, mainQuesCounter, mainWorkQueue, resArraysCounter, iterationNumber)
	processPaddingPlane(
		sourceArray[34, threadIdxX(), threadIdxY()], x + 34, y, z, true, false, false, false, false, false, 11, shmem, currBlockX, currBlockY, currBlockZ, sourceArray, referenceArray, resArr, metaData, metadataDims, isPassGold, mainQuesCounter,
		mainWorkQueue, resArraysCounter, iterationNumber)# this arguments will be the same for all invocations
end
end#ProcessPadding