...
using CUDA
export @setMeta, @accMeta, getIsToBeAnalyzedNumb, getIsToBeActivatedInSegmNumb, getIsToBeActivatedInGoldNumb, getFullInSegmNumb, getFullInGoldNumb, setBlockasCurrentlyActiveInGold, setBlockasCurrentlyActiveInSegm, getActiveGoldNumb, getActiveSegmNumb,
	getResOffsetsBeg, getOldCountersBeg, getNewCountersBeg, getBeginingOfFpFNcounts, getBeginingOfXYZ, setBlockasCurrentlyActiveInGold, setBlockasCurrentlyActiveInSegm
...
10-24) getIsToBeAnalyzedNumb::Bool
...
function allocateMetadata(arrDims, dataBDims)
	return CUDA.zeros(UInt32, cld(arrDims[1], dataBDims[1]), cld(arrDims[2], dataBDims[2]), cld(arrDims[2], dataBDims[3]), 90)
end
"""
...
function getActiveGoldNumb()::UInt32
	return 1
end
function getActiveSegmNumb()::UInt32
	return 2
end

function getFullInGoldNumb()::UInt32
	return 3
end
function getFullInSegmNumb()::UInt32
	return 4
end

function getIsToBeActivatedInGoldNumb()::UInt32
	return 5
end
function getIsToBeActivatedInSegmNumb()::UInt32
	return 6
end

function getIsToBeAnalyzedNumb()::UInt32
	return 9
end


function getResOffsetsBeg()::UInt32
	return 41
end

function getOldCountersBeg()::UInt32
	return 59
end
function getNewCountersBeg()::UInt32
	return 74
end
